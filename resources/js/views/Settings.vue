...
<template>
        <div  v-if="settings && characterOptions" id="settings-container">
            ...
            <template v-if="settings.notifications.includes('hasDistanceNotifications')">
                <div class="setting-input-container" >
                    <FloatLabel>
                        <InputNumber id="settings-distance-notifications-radius" class="setting-input" v-model.number="settings.distanceNotificationsRadius" @click="settingsValidationErrors.distanceNotificationsRadius = []" :min="1" :max="2000" suffix=" KM" :maxFractionDigits="0"/>
