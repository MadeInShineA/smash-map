    ...
    <div id="inputs-container">
        <div class="input-errors-container">
            <div class="input-container">
                <FloatLabel>
                    <InputText
                        ...
                        class="input"
                        v-model="email"
                        @click="resetPasswordErrors.email = []"
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="emailError in resetPasswordErrors.email"
                        :key="emailError"
        ...
        <div class="input-errors-container">
            <div class="input-container">
                <FloatLabel>
                    <Password
                        ...
                        toggle-mask
                        :feedback="false"
                        @click="resetPasswordErrors.password = []"
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="passwordError in resetPasswordErrors.password"
                        :key="passwordError"
                        class="validation-errors"
                    >
        ...
        <div class="input-errors-container">
            <div class="input-container">
                <FloatLabel>
                    <Password
                        ...
                        toggle-mask
                        :feedback="false"
                        @click="resetPasswordErrors.passwordConfirmation = []"
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="passwordError in resetPasswordErrors.passwordConfirmation"
                        :key="passwordError"
                        class="validation-errors"
                    >
                        <div class="validation-error">{{ passwordError }}</div>
