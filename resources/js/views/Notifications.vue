...
userStore
    .getNotifications(lastNotificationId.value, props.darkMode)
    .then((response) => {
        ...
        <div v-for="notification in notifications" class="notification">
            <div class="notification-image-container">
                <img
                    ...
                    alt="Notification's image"
                    width="50px"
                />
            </div>
            <div class="notification-text-container">
                <h3>
                    {{ notification.notificationType }} for
                    {{ notification.gameTitle }} on {{ notification.createdAt }}
                </h3>
                <p
