...
<template>
    <Sidebar :visible="sideBarVisible" @update:visible="emit('switchSideBarVisible')" position="top"
        ...
        <div id="event-filters">
            ...
            <div class="event-filter">
                <Dropdown v-model="addressFiltersStore.selectedAddressTypes" :options="userStore.user.data.id ? optionsStore.addressTypeOptions : optionsStore.connectedUserAddressTypeOptions"
