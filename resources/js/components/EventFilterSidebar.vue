...
<template>
    <Sidebar :visible="sideBarVisible" @update:visible="emit('switchSideBarVisible')" position="top" style="text-align: center; height: min-content; max-height:100vh">
        ...
        <div id="event-filters">
            ...
            <div class="event-filter">
                <Dropdown v-model="filtersStore.selectedEventTypes" :options="userStore.user.data.id ? optionsStore.eventTypeOptions : optionsStore.connectedUserEventTypeOptions" optionLabel="name" optionValue="value" placeholder="All event types"/>
            </div>
            <div class="event-filter">
