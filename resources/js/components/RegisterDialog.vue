...
watch(
    ...
    function (availableCharacters, oldValue) {
        ...
        if (oldValue && availableCharacters.length !== 0) {
            ...
            registerUser.characters = registerUser.characters.filter(
                (character) => {
        ...
        try {
            await userStore
                ...
                .then(async function (response) {
                    ...
                    const alertBackground = props.darkMode
                        ? "#1C1B22"
                        : "#FFFFFF";
...
<template>
    <Dialog
        ...
        @update:visible="emit('switchShowRegisterModal')"
        :draggable="false"
        modal
        header="Register"
        :style="{ width: '30vw' }"
        :breakpoints="{ '1200px': '50vw', '575px': '90vw' }"
    >
        <template
            #header
            class="p-dialog-title p-dialog-header margin-auto"
        ></template>
        <div v-if="characterOptions">
            <div class="modal-input-container">
                <FloatLabel>
                    <InputText
                        ...
                        required
                        autofocus
                        @focus="registerValidationErrors.username = []"
                        maxlength="20"
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerUsernameError in registerValidationErrors.username"
                        :key="registerUsernameError"
            ...
            <div class="modal-input-container">
                <FloatLabel>
                    <InputText
                        ...
                        @focus="registerValidationErrors.email = []"
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerEmailError in registerValidationErrors.email"
                        :key="registerEmailError"
                        class="validation-errors"
                    >
                        <div class="validation-error">
                            {{ registerEmailError }}
            ...
            <div class="modal-input-container">
                <FloatLabel>
                    <Password
                        ...
                        :feedback="false"
                        toggleMask
                        @focus="registerValidationErrors.password = []"
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerPasswordError in registerValidationErrors.password"
                        :key="registerPasswordError"
                        class="validation-errors"
                    >
                        <div class="validation-error">
            ...
            <div class="modal-input-container">
                <FloatLabel>
                    <Password
                        ...
                        toggleMask
                        @focus="
                            registerValidationErrors.passwordConfirmation = []
                        "
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerPasswordConfirmationError in registerValidationErrors.passwordConfirmation"
                        :key="registerPasswordConfirmationError"
                        class="validation-errors"
                    >
                        <div class="validation-error">
            ...
            <div class="modal-input-container">
                <FloatLabel>
                    <MultiSelect
                        id="register-games"
                        class="modal-input"
                        v-model="registerUser.games"
                        :options="optionsStore.gameOptions"
                        optionLabel="name"
                        optionValue="id"
                        :maxSelectedLabels="0"
                        placeholder="Games"
                        @focus="registerValidationErrors.games = []"
                    />
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerGamesError in registerValidationErrors.games"
                        :key="registerGamesError"
                        class="validation-errors"
                    >
                        <div class="validation-error">
                            {{ registerGamesError }}
            ...
            <div class="modal-input-container">
                <FloatLabel>
                    <MultiSelect
                        ...
                        class="modal-input"
                        :disabled="registerUser.games.length === 0"
                        :loading="!charactersFetched"
                        v-model="registerUser.characters"
                        :maxSelectedLabels="0"
                        ...
                        showClear
                        @focus="registerValidationErrors.characters = []"
                    >
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerCharactersError in registerValidationErrors.characters"
                        :key="registerCharactersError"
                        class="validation-errors"
                    >
                        <div class="validation-error">
                            {{ registerCharactersError }}
                        </div>
                    </template>
                </TransitionGroup>
            </div>
            ...
            <div class="modal-input-container">
                <Checkbox
                    v-model="registerUser.isModder"
                    :binary="true"
                    input-id="register-is-moder"
                />
                <label for="register-is-moder" class="ml-10">
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerIsModder in registerValidationErrors.isModder"
                        :key="registerIsModder"
                        class="validation-errors"
                    >
                        <div class="validation-error">
                            {{ registerIsModder }}
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerAddressNameError in registerValidationErrors.addressName"
                        :key="registerAddressNameError"
                        class="validation-errors"
                    >
                        <div class="validation-error">
                            {{ registerAddressNameError }}
                        </div>
                    </template>
                </TransitionGroup>
            </div>
            ...
            <div class="modal-input-container">
                <Checkbox
                    v-model="registerUser.isOnMap"
                    :binary="true"
                    input-id="register-is-on-map"
                />
                <label for="register-is-on-map" class="ml-10">
            ...
            <div class="validation-errors">
                <TransitionGroup name="errors">
                    <template
                        v-for="registerIsOnMap in registerValidationErrors.isOnMap"
                        :key="registerIsOnMap"
                        class="validation-errors"
                    >
                        <div class="validation-error">
        ...
        <template #footer>
            <Button
                ...
                severity="danger"
                icon="pi pi-times"
                @click="emit('switchShowRegisterModal')"
                text
                plain
            />
            <Button
