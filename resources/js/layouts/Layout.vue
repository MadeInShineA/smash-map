                    ...
                    try {
                        await userStore
                            ...
                            .then(async function (response) {
                                const alertBackground = darkMode.value
                                    ? "#1C1B22"
                                    : "#FFFFFF";
                                const alertColor = darkMode.value
                                    ? "#FFFFFF"
                                    : "#1C1B22";
                                await Swal.fire({
                                    title: "Logged out!",
                        ...
                        if (
                            ...
                            const alertBackground = darkMode
                                ? "#1C1B22"
                                : "#FFFFFF";
...
<template>
        ...
        >
            <template #start>
                ...
                <template v-else>
                    ...
                    >
                        <Avatar
                            :image="userStore.user.data.profilePicture.url"
                            shape="circle"
                        />
                    </Button>
                    ...
                    <router-link to="/notifications">
                        <Button
                            v-if="userStore.notificationsCountFetched"
                            plain
                            text
                            icon="pi pi-bell"
                            :badge="
                                userStore.notificationsCount > 0
                                    ? userStore.notificationsCount.toString()
                                    : null
                            "
                            badgeClass="p-badge-success"
                            :label="
                                notificationLabelDisplayed
                                    ? 'Notifications'
                                    : null
                            "
                        />
    ...
    <main>
        ...
        <LoginDialog
            ...
            @switchShowLoginModal="switchShowLoginModal"
        />
        <template v-if="isAndroid && canBeInstalledAndroid">
            <Sidebar
                id="install-sidebar"
                v-model:visible="displayInstallApp"
                position="bottom"
                header=" "
                style="height: auto"
            >
        ...
        <template v-else-if="isAndroid && !isStandaloneAndroid">
            ...
            >
                <div id="install-sidebar-content">
                    <p>The Smash Map app is available on Android</p>
                    <p>
                        To install the app, click on the three dots in the top
                        right corner or the three lines in the bottom right and
        ...
        <template v-else-if="isIOS && canBeInstalledIOS && !isInstalledIOS">
            ...
            >
                <div id="install-sidebar-content">
                    ...
                    <p>
                        To install the app, click on the share button and click
                        "Add to Home Screen"
                    </p>
                </div>
            </Sidebar>
        ...
        <RegisterDialog
            ...
            @switchShowRegisterModal="switchShowRegisterModal"
        />
        <router-view v-slot="{ Component }">
            <keep-alive :include="['map']">
                <component
                    :darkMode="darkMode"
                    :is="Component"
                    :responsiveMenuDisplayed="responsiveMenuDisplayed"
                />
            </keep-alive>
        </router-view>
    </main>
