...
class NotificationController extends Controller
{
    public function get_notifications(
        ...
        try {
            ...
            return $this->sendResponse(
                $data,
                "Notifications retrieved with success",
            );
        } catch (Error $error) {
            return $this->sendError(
                $error,
                ["An error occurred while retrieving the notifications E 015"],
                500,
            );
        }
    }
    ...
    public function get_notifications_count(
        ...
        return $this->sendResponse(
            [$notifications_count],
            "Notifications count retrieved with success",
        );
    }
}
