...
class SettingsUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "notifications.*" => [
                "required",
                "in:hasDistanceNotifications,hasTimeNotifications,hasAttendeesNotifications",
            ],
            // TODO Fix the distanceNotifications... not being required properly
            "distanceNotificationsRadius" => [
                "nullable",
                "required_if:notifications.*,hasDistanceNotifications",
                "numeric",
                "min:1",
                "max:2000",
            ],
            "attendeesNotificationsThresholds" => [
                "nullable",
                "required_if:notifications.*,hasAttendeesNotifications",
                "array",
                "min:1",
            ],
            ...
            "timeNotificationsThresholds" => [
                "nullable",
                "required_if:notifications.*,hasTimeNotifications",
                "array",
                "min:1",
            ],
