...
class Event extends Model
{
    ...
    {
        $start_date = Carbon::parse($this->start_date_time)->setTimezone(
            $this->timezone,
        );

        $end_date = Carbon::parse($this->end_date_time)->setTimezone(
            $this->timezone,
        );
    ...
    {
        return $query->whereHas("address.country", function ($query) use (
            $countries,
        ) {
    ...
    {
        return $query->whereHas("address.country.continent", function (
            $query,
        ) use ($continents) {
