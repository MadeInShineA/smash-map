...
Route::middleware(["auth:sanctum"])->group(function () {
    ...
    Route::post("/events/{event}/subscribe", [
        EventController::class,
        "event_subscribe",
    ]);
    Route::post("/events/{event}/unsubscribe", [
        EventController::class,
        "event_unsubscribe",
    ]);
    Route::get("/users/{user}/check-authentication", [
        UserController::class,
        "check_authentication",
    ]);
    Route::get("/beams-auth-endpoint", [
        UserController::class,
        "beams_auth_endpoint",
    ]);
    Route::middleware(["check-authentication"])->group(function () {
        Route::delete("/users/{user}", [UserController::class, "destroy"]);
        Route::get("/users/{user}/notifications/count", [
        ...
        Route::put("/users/{user}/settings", [
            SettingsController::class,
            "update_settings",
        ]);
        Route::put(
            "/users/{user}/settings/update-distance-notifications-radius",
            [SettingsController::class, "update_distance_notifications_radius"],
        );
        Route::get("/users/{user}/profile", [
            UserController::class,
            "get_profile",
        ]);
        Route::put("/users/{user}/profile/", [
            UserController::class,
            "update_profile",
        ]);
    });
